  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && 'text-purple-900 bg-purple-200 hover:bg-purple-200 hover:text-purple-700 border-l-8' // Add transition class here
      )}
    >
      <div className="flex items-center gap-x-2 py-4">
        <Icon size={22} className={cn('text-purple-800', isActive && 'text-purple-800')} />
        {label}
      </div>
      <div
        className={cn(
